...
from model import ADPMDA, NSNA, NSA, SNA


def Train(directory, epochs, k, attn_size, out_dim, dropout, slope, lr, wd, random_seed, cuda, model_type):
